...
| `docs/TRD.md` | Full technical spec — the authoritative "what". Feed to Claude Code for implementation. |
...
└── CLAUDE.md                      # Developer onboarding (read automatically by Claude Code)
```
